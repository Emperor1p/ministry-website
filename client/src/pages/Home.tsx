...
import { useCreateInquiry, useFaqs, useGallery } from "@/hooks/use-ministry-data";
  ...
  return (
    <div className="min-h-screen bg-background font-sans overflow-x-hidden">
        ...
        <div className="container relative z-10 px-4 md:px-6 pt-20">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-white border border-white/20 mb-6">
              ...
              <span className="text-sm font-medium tracking-wide">Bringing Hope & Dignity</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-display text-white leading-tight mb-6">
              Honoring the <span className="text-primary italic">God of Ages</span> by Serving the Aged
            </h1>
            
            <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl leading-relaxed">
              We are dedicated to providing compassionate care, essential support, and a community of love for our elderly generation.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <ScrollLink to="donate" smooth={true} duration={500}>
                <Button size="lg" className="w-full sm:w-auto text-base px-8 h-14 rounded-full shadow-xl shadow-primary/20 hover:scale-105 transition-transform duration-200">
                  Support the Mission
                </Button>
              </ScrollLink>
              <ScrollLink to="about" smooth={true} duration={500}>
                <Button variant="outline" size="lg" className="w-full sm:w-auto text-base px-8 h-14 rounded-full bg-white/5 text-white border-white/30 hover:bg-white/10 hover:text-white backdrop-blur-sm">
                  Learn More
                </Button>
              </ScrollLink>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-8 -right-8 bg-white p-6 rounded-xl shadow-xl border border-border max-w-[200px] hidden md:block">
                <p className="text-4xl font-bold text-primary font-display mb-1">500+</p>
                <p className="text-sm text-muted-foreground font-medium">Lives touched through our outreach programs</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                <span className="font-semibold text-foreground">God of Ages Ministry</span> was founded by <span className="text-primary font-medium">God set man</span> with a divine mandate to care for the elderly in our society. We believe that old age should be a time of peace, comfort, and joy, not struggle.
              </p>
              
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                In a fast-paced world that often overlooks the aged, we stand in the gap to provide financial assistance, healthcare support, and most importantly, the warmth of companionship.
              </p>
        ...
        <div className="container px-4 md:px-6">
              ...
              <Card className="h-full border-none shadow-lg overflow-hidden relative bg-white">
                ...
                <CardContent className="p-8 md:p-10">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    To create a world where every elderly person feels valued, cherished, and supported, living out their golden years with dignity, purpose, and joy under the grace of God.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card className="h-full border-none shadow-lg overflow-hidden relative bg-white">
                ...
                <CardContent className="p-8 md:p-10">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We are on a mission to mobilize resources and compassionate hearts to provide holistic care—physical, emotional, and spiritual—to the aged, ensuring no one walks the path of old age alone.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
          ...
          <div className="mt-20">
            <div className="text-center mb-12">
              <h3 className="text-2xl font-bold font-display mb-4">How We Help</h3>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Our ministry focuses on tangible ways to improve the quality of life for our seniors.
              </p>
            </div>
              ...
              {[
                {
                  icon: Utensils,
                  title: "Food & Clothing",
                  description: "Providing nutritious meals and comfortable clothing to those in need.",
                  color: "bg-orange-100 text-orange-600"
                },
                {
                  icon: Stethoscope,
                  title: "Healthcare Support",
                  description: "Assisting with medical checkups, medications, and health monitoring.",
                  color: "bg-blue-100 text-blue-600"
                },
                {
                  icon: Heart,
                  title: "Emotional Support",
                  description: "Offering companionship and listening ears to combat loneliness.",
                  color: "bg-rose-100 text-rose-600"
                }
              ].map((item, index) => (
                <motion.div key={index} variants={itemVariants} className="bg-white p-8 rounded-2xl border border-border shadow-sm hover:shadow-lg transition-shadow text-center">
                  <div className={`w-16 h-16 ${item.color} rounded-full flex items-center justify-center mx-auto mb-6`}>
                    <item.icon className="h-8 w-8" />
                  </div>
                  <h4 className="text-xl font-bold font-display mb-3">{item.title}</h4>
      ...
      {/* ============================================
          DONATE SECTION
      ============================================ */}
      <section id="donate" className="py-20 md:py-32 bg-primary relative overflow-hidden text-white">
        {/* Abstract Pattern */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/80 text-lg mb-8 leading-relaxed">
                Every donation goes directly towards food, medication, and care for the elderly in our community. Join us in making their golden years shine brighter.
              </p>
            ...
            >
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold font-display mb-2">Bank Transfer Details</h3>
                <p className="text-muted-foreground">Direct donations to our ministry account</p>
              </div>

              <div className="bg-muted/50 rounded-xl p-6 mb-8 border border-border">
                <div className="space-y-4">
                  <div className="flex justify-between items-center pb-4 border-b border-border/50">
                    <span className="text-muted-foreground text-sm uppercase tracking-wider font-semibold">Bank Name</span>
                    <span className="font-bold text-lg">Zenith Bank</span>
                  </div>
                  <div className="flex justify-between items-center pb-4 border-b border-border/50">
                    <span className="text-muted-foreground text-sm uppercase tracking-wider font-semibold">Account Name</span>
                    <span className="font-bold text-lg text-right">God of Ages Ministry</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground text-sm uppercase tracking-wider font-semibold">Account Number</span>
                    <span className="font-bold text-2xl font-mono text-primary">1012345678</span>
                  </div>
                </div>
              </div>
          ...
          {isFaqsLoading ? (
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              {faqs?.length ? (
                ...
                [
                  { q: "How can I volunteer?", a: "We welcome volunteers! Please fill out the contact form below or email us directly to join our outreach team." },
                  { q: "Is my donation tax-deductible?", a: "Yes, we are a registered non-profit organization. We provide receipts for all donations upon request." },
                  { q: "Do you have a physical location?", a: "Yes, our ministry office is open Monday to Friday. See the footer for our address." },
                ].map((item, i) => (
                  <AccordionItem 
                    key={i} 
                    value={`item-${i}`}
            ...
            <div className="md:col-span-2 bg-foreground text-white p-10 flex flex-col justify-between">
              <div>
                ...
                <p className="text-white/70 mb-10">
                  Have questions or want to get involved? Fill out the form or reach out to us directly.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">123 Ministry Lane, Care City</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12">
                <p className="font-display italic text-white/50 text-lg">
                  ...
                  <br />
                  <span className="text-sm not-italic mt-2 block">— Psalm 71:9</span>
                </p>
              </div>
            </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="John Doe" className="bg-muted/30 border-border h-12 rounded-lg" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="john@example.com" type="email" className="bg-muted/30 border-border h-12 rounded-lg" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="How can we help you?" className="bg-muted/30 border-border min-h-[150px] rounded-lg resize-none" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
